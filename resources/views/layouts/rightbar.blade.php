    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label" style="background-image:url('{{ asset('assets/admin/assets/images/avatars/ays.png') }}')"></div>
                <i class="symbol-badge bg-success"></i>
            </div>
            <div class="d-flex flex-column">
                <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">Ad Soyad</a>
                <div class="text-muted mt-1"><strong class="text-black-50"></strong></div>
                <div class="navi mt-2">
                    <span class="navi-item">
                        <span class="navi-link p-0 pb-2">
                            ...
                            <span class="navi-text text-muted text-hover-primary">eposta@adresi.com</span>
                        </span>
                    </span>
        ...
        <div class="navi navi-spacer-x-0 p-0">
            ...
            <a href="#" class="navi-item">
                <div class="navi-link">
                    ...
                    <div class="navi-text">
                        <div class="font-weight-bold">Profil Düzenle</div>
                        <div class="text-muted">Hesap ve Kişisesl Bilgiler</div>
                    </div>
                </div>
            </a>
            <!--end:Item-->
...
{{--                    </div>--}}
{{--                    <div class="navi-text">--}}
{{--                        <div class="font-weight-bold">Ayarlar</div>--}}
{{--                        <div class="text-muted">Güvenlik İşlemleri</div>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </a>--}}
